...
Frame Server 选择 720p/1080p 与 30/60 fps 后，该运行周期的输出类型保持稳定；Shared Frame Ring
画面在 Source 内等比缩放并以黑边补齐，placeholder/live 切换不会触发动态格式重协商。
Source 在提交协商类型时同时验证 NV12、BT.709 limited、progressive、方形像素、紧凑 stride
和 sample size；30/60 fps 的 duration 分别保持 333333/166666 个 100ns。

...
关联 ARCH-PICOO-MEDIA-002、REQ-PICOO-NEXT-016。该 fork 基于 gpui-pre-apple 0.3.6，保留 Picoo Metal surface 生命周期修补；来源、固定 release checksum 与许可证见 ORIGIN.json / LICENSE-APACHE，Cargo 根 manifest 通过 patch 选择它；没有引入另一套桌面框架。

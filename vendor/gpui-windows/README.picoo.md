...
关联 ARCH-PICOO-MEDIA-002、REQ-PICOO-NEXT-016 与 REQ-PICOO-GPU-008。该 fork 基于 gpui-pre-windows 0.3.6，保留 Picoo Direct3D surface 与窗口修复；来源、校验和及许可证见 ORIGIN.json 和 LICENSE-APACHE，根 Cargo.toml 使用局部 patch。

        ...
        for (size_id, scaling_column) in scaling_list.iter_mut().enumerate() {
            ...
            while matrix_id < 6 {
                ...
                if !scaling_list_pred_mode_flag {
                    ...
                    let delta = bit_reader.read_exp_golomb()?;
                    range_check!(delta, 0, (matrix_id / if size_id == 3 { 3 } else { 1 }) as u64)?;
                    let scaling_list_pred_matrix_id_delta = delta as usize;

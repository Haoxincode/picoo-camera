...
| REQ-PICOO-PROTOCOL-008 | implemented | ARCH-PICOO-PROTOCOL-001 | StartStream/StopStream 使用 magic 判别（1/2），避免空 message 误解码 | `unpaired_start_stream_is_rejected` + `paired_start_stop_stream_and_camera_command_roundtrip` |

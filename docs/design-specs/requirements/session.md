...
| REQ-PICOO-SESSION-005 | implemented | PRD §21 | 2h 长稳无崩溃、内存不增长 | `scripts/soak_loopback.sh` + ignored soak（Linux OpenH264；默认 60s；已跑 90s RSS 平台；`SOAK_SECONDS=7200` 做 2h） |

...
| REQ-PICOO-SESSION-003 | proposed | ARCH-PICOO-SESSION-001 | 不完整非关键帧丢弃，关键帧丢则请求 IDR | packet + session 测试 |
| REQ-PICOO-SESSION-004 | proposed | PUC-006 | 重连后恢复分辨率/镜像并请求 SPS/PPS/IDR | 集成测试 |

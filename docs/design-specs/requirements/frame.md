...
| REQ-PICOO-FRAME-006 | planned | ARCH-PICOO-FRAME-001 / ARCH-PICOO-VCAM-001 | macOS 主应用与 Camera Extension 通过 App Group mmap 共享 NV12 帧环 | 与 Windows Shared Frame Ring 使用相同布局与提交序列语义；扩展只读；进程重启、慢消费者与 torn frame 测试 |

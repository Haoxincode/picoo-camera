...
| REQ-PICOO-PAIRING-003 | implemented | PUC-001 | 未配对设备不得 StartStream/收视频/驱动 VCam | `unpaired_sender_video_is_dropped` + `unpaired_video_keeps_shared_ring_on_placeholder` |

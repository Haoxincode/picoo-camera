...
| REQ-PICOO-PAIRING-008 | implementing | ARCH-PICOO-DISCOVERY-001 | 首次配对 SAS 由双方独立从双方公钥、双方随机 nonce、设备 ID 与 TLS exporter 派生；双方分别确认后以 Ed25519 签完整 transcript | canonical transcript、Ed25519 phase signature、SAS channel-binding 单测与 Quinn exporter 已覆盖；Sender/Receiver 握手接入和重放测试完成后升级 implemented |
